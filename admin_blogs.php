  ...
  <head>
    ...
    $(document).ready(function () {
      ...
      var table = $('#Blog_table').DataTable({
         order: [[ 6, "desc" ]], // Sort by Created Time column (index 6) in descending order
  ...
  <?php show_navbar(); ?>
    ...
    <div class="toggle_columns">
      Toggle column: <a class="toggle-vis" data-column="0">Blog ID</a>
        ...
        - <a class="toggle-vis" data-column="4">Video_Link</a>
        - <a class="toggle-vis" data-column="5">Modified_Time</a>
        - <a class="toggle-vis" data-column="6">Created_Time</a>
		- <a class="toggle-vis" data-column="7">Option</a>
