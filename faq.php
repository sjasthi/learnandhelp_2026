...
.intro-banner p {
      max-width:820px; margin:0 auto; font-size:1.05rem; line-height:1.65;
    }
.intro-banner h1 {
      font-family:'Montserrat',sans-serif; font-size:3rem; font-weight:900; margin:0 0 22px;
    }
...
<section class="intro-banner">
  <h1><span class="accent-text">Frequently Asked Questions</span></h1>
  <p>Answers to the most common questions about our classes, policies, and how Learn & Help works. Click the question to see the answer</p>
</section>
