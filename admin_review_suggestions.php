...
$sql = "SELECT * FROM schools_suggested ORDER BY id DESC";
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <form style="display: inline;" action="move_to_schools.php" method="post" 
                                              onsubmit="return confirm('Move this school to the main schools list?');">
                                            <input type="hidden" name="suggested_school_id" value="<?= $row['id'] ?>">
                                            <button type="submit" class="action-btn btn-move" title="Move to Schools">
